 ...
 */
@Autonomous(name = "Competition Autonomous", group = "Autonomous", preselectTeleOp = "Competition TeleOp")
public class AutoOpMode extends LinearOpMode{
    ...
    public void runAutoAndParking(){
        ...
        telemetry.addData("Running FTC Wires (ftcwires.org) Autonomous Mode adopted for Team:","21233");
        telemetry.addData("---------------------------------------","");
        telemetry.update();
    ...
    public void selectStartingPosition() {
        ...
        while(!isStopRequested()){
            telemetry.addData("Initializing FTC Wires (ftcwires.org) Autonomous Mode adopted for Team:","21233");
            telemetry.addData("---------------------------------------","");
